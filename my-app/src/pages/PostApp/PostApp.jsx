      ...
      <div className="w-full max-w-lg bg-white p-6 rounded-lg shadow-lg mb-8">
        ...
        <form onSubmit={handleSubmit}>
          <div className="mb-4">
            ...
            <input id="title" name="title" type="text" value={formData.title} onChange={handleInputChange} className="mt-2 p-3 w-full border border-gray-300 rounded-md" required />
          </div>
          ...
          <div className="mb-4">
            ...
            <textarea id="body" name="body" value={formData.body} onChange={handleInputChange} className="mt-2 p-3 w-full border border-gray-300 rounded-md" required />
          </div>
