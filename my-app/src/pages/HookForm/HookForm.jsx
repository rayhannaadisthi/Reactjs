    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-gray-100 p-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-lg bg-white p-6 rounded-lg shadow-lg">
        ...
        <div className="mb-4">
          ...
          <input id="email" type="email" {...register("email", { required: "Email is required" })} className="mt-2 p-3 w-full border border-gray-300 rounded-md" />
        </div>
        ...
        <button type="reset" className="w-full mt-4 bg-red-500 text-white p-3 rounded-md hover:bg-red-600">
          Reset
        </button>
      </form>
